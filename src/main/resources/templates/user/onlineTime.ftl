...
<script type="text/javascript" src="../static/js/web/user/onlineTime.js"></script>
<div class="m-b-md">
    <form class="form-inline" role="form" id="searchForm"
          name="searchForm">
        <div class="form-group">
            <label class="control-label">用户ID<span
                class="h4 font-thin v-middle"></span></label> <input
                class="input-medium ui-autocomplete-input" id="userId"
                name="wechatUserFromMap.userId">
            <label class="control-label"> <span
                    class="h4 font-thin v-middle"></span></label> 时间&nbsp;<input
